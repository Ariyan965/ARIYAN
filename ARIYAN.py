...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mAriyA'n SiN'gg
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801814401965
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mAriyan Ahmed Nazmul
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://youtube.com/channel/UCAII3xrWaWIfJgeyRujfDhg")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [AriyA'n] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [AriyA'n-CP] %s|%s        '%(b,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://www.facebook.com/horny.lover.xxx1 ")
	menu()
